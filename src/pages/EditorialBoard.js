      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">1. Dr. Yogesh Gurav</p>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">2. Dr. Sandeep Kadam</p>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">3. Dr. M. Venkateshwara Rao</p>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">4. Dr. Pramod Ganjewar</p>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">5. Dr. Manish Giri</p>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">6. Dr. G. Arun</p>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <p className="font-medium">7. Dr. Royyuru Srikanth</p>
