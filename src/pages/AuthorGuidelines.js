        ...
        <div ref={componentRef} className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 print:p-6">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <a href={paperTemplatePdf} download="Paper Template.docx" className="inline-flex items-center px-5 py-2.5 bg-amber-700 hover:bg-amber-800 text-white font-medium rounded-lg transition-colors">
